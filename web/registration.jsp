                                        ...
                                        <form action="OrderController?action=register" method="post">
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <br>
                                                        <input type="email" name="username" id="username" placeholder="Enter email" maxlength="30" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <br>
                                                        <input type="text" name="firstName" id="firstName" placeholder="Enter first name" maxlength="20" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <br>
                                                        <input type="text" name="lastName" id="lastName" placeholder="Enter last name" maxlength="20" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <br>
                                                        <input type="text" name="addLine1" id="addLine1" placeholder="Enter address" maxlength="30" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <br>
                                                        <input type="text" name="addLine2" id="addLine2" placeholder="Enter address" maxlength="30" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <br>
                                                        <input type="text" name="state" id="state" placeholder="Enter state" maxlength="20" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <br>
                                                        <input type="text" name="country" id="country" placeholder="Enter country" maxlength="20" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <br>
                                                        <input type="text" name="zipCode" id="zipCode" placeholder="Enter zip code" maxlength="11" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
